...
public class SampleMecanumDrive extends MecanumDrive {
    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(7, 2, 1);
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(9, 2, 1);

    public static double LATERAL_MULTIPLIER = 2.2535521637264767433774;
